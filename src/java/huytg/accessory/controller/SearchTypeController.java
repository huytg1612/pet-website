 ...
 */
package huytg.accessory.controller;
...
public class SearchTypeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String search = request.getParameter("txtAccessorySearch");

            if (!search.equals("All")) {
                AccessoryDAO dao = new AccessoryDAO();
                List<AccessoryDTO> list = dao.findByType(search);
                request.setAttribute("LIST_Accessory", list);
            } else {
                AccessoryDAO dao = new AccessoryDAO();
                List<AccessoryDTO> list = dao.searchByLikeName("","customer");
                request.setAttribute("LIST_Accessory", list);
            }
