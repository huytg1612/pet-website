...
public class InvoiceController extends HttpServlet {
    ...
    private static final String SUCCESS = "user/invoice.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<InvoiceDTO> list = dao.getByUsername(username);

            request.setAttribute("LIST_Invoice", list);
            url = SUCCESS;
        } catch (Exception e) {
            System.out.println("Error at Invoicecontroller: " + e.getMessage());
        } finally {
