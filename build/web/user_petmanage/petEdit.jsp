            ...
            <div id="component-right">
                ...
                <div id="form-container">
                    <form action="PetMainController" method="POST">
                        <input type="hidden" name="txtPetID" value="${requestScope.DTO_Pet.id}"/>

                        <div class="form-group">
                            <label for="exampleInputText">Pet name</label>
                            <input type="text" class="form-control" id="exampleInputText" name="txtPetName" value="${requestScope.DTO_Pet.name}">
                            <p class="error-notice">${requestScope.INVALID.nameError}</p>
                        </div>
                        <div class="form-group">
                            Date of birth:<input type="date" class="form-control" id="validationDefault02" name="txtPetDOB" value="${requestScope.DTO_Pet.dob}">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Sex</label>
                            <select class="form-control" id="cboPetSex" name="cboPetSex">
                                <option>Male</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="cboPetType" name="cboPetType" value="${requestScope.DTO.Pet.type}">
                                <option>Dog</option>
                                <option>Cat</option>
                                <option>Fish</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="txtPetDescription" value="${requestScope.DTO_Pet.descrip}"></textarea>
                        </div>
