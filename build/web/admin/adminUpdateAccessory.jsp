                    ...
                    <form action="AdminAccessoryMainController" method="POST"  style="background-color: white;padding: 2%">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Accessory Price"
                                   name="txtAccessoryPrice" value="${dtoAccess.getPrice()}" step="0.1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Accessory Quantity"
                                   name="txtAccessoryQuantity" value="${dtoAccess.getQuantity()}">
                            <p class="invalid">${requestScope.INVALID.name}</p>
                        </div>
                        <div class="form-group">
                            ...
                            <p class="invalid">${requestScope.INVALID.type}</p>
                        </div>
                        <div class="form-group">
                            ...
                            <p class="invalid">${requestScope.INVALID.madeIn}</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="txtAccessoryDescrip" value="${dtoAccess.getDescription()}">${dtoAccess.description}</textarea>
                        </div>
                        <br>
