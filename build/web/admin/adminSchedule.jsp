                            ...
                            <tbody>
                                <c:forEach var="dtoSchedule" items="${list}" varStatus="theCount">
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${dtoSchedule.status == 0}" var="waiting">
                                        ...
                                        <c:if test="${waiting}">
                                            <td>
                                                <form action="AdminScheduleMainController" method="POST" onsubmit="return confirm('Do yo want to set done?');">
                                                    <button class="btn btn-outline-success" type="submit" name="action" value="Update">
                                                        Set done</button>
                                            ...
                                            <td>
                                                <form action="AdminScheduleMainController" method="POST" onsubmit="return confirm('Do you want to set cancel?');" >
                                                    <button class="btn btn-outline-danger" type="submit" name="action" value="Update">
                                                        Set cancel</button>
